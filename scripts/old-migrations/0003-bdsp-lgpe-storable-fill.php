...
JSON;
    ...
    $storables = [
        'bdsp' => sgg_data_load('builds/pokemon/storable/storable-pokemon-bdsp.json'),
        'lgpe' => sgg_data_load('builds/pokemon/storable/storable-pokemon-lgpe.json'),
    ];
    ...
    foreach ($dataSet as $i => $pkm) {
        ...
        foreach ($storables as $gameSetId => $storablePkmIds) {
            ...
            if (in_array($pkmId, $storablePkmIds, true)) {
